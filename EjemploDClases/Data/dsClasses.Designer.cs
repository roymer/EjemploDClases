...
namespace EjemploDClases.Data {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("dsClasses")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class dsClasses : global::System.Data.DataSet {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        protected dsClasses(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            dsClasses cln = ((dsClasses)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "dsClasses";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/dsClasses.xsd";
        ...
        public partial class PersonDataTable : global::System.Data.TypedTableBase<PersonRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PersonRow AddPersonRow(string FirstName, string LastName, string Email, string Adress, int Phone, System.DateTime Date) {
        ...
        public partial class PersonRow : global::System.Data.DataRow {
            ...
            public System.DateTime Date {
                get {
                    try {
                        return ((global::System.DateTime)(this[this.tablePerson.DateColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Date\' in table \'Person\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablePerson.DateColumn] = value;
                }
            }
            ...
            public bool IsDateNull() {
                return this.IsNull(this.tablePerson.DateColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetDateNull() {
                this[this.tablePerson.DateColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace EjemploDClases.Data.dsClassesTableAdapters {
    ...
    public partial class PersonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Person] WHERE (([Id] = @Original_Id) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ([Email] = @Original_Email) AND ([Adress] = @Original_Adress) AND ([Phone] = @Original_Phone) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Person] ([FirstName], [LastName], [Email], [Adress], [Phone], [Date]" +
                ") VALUES (@FirstName, @LastName, @Email, @Adress, @Phone, @Date);\r\nSELECT Id, Fi" +
                "rstName, LastName, Email, Adress, Phone, Date FROM Person WHERE (Id = SCOPE_IDEN" +
                "TITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Person] SET [FirstName] = @FirstName, [LastName] = @LastName, [Email] = @Email, [Adress] = @Adress, [Phone] = @Phone, [Date] = @Date WHERE (([Id] = @Original_Id) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ([Email] = @Original_Email) AND ([Adress] = @Original_Adress) AND ([Phone] = @Original_Phone) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)));
SELECT Id, FirstName, LastName, Email, Adress, Phone, Date FROM Person WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::EjemploDClases.Properties.Settings.Default.dbClassesConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        Id, FirstName, LastName, Email, Adress, Phone, Date\r\nFROM          " +
                "  Person\r\nWHERE        (FirstName LIKE \'%\' + @par + \'%\') OR\r\n                   " +
                "      (LastName LIKE \'%\' + @par + \'%\')";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@par", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "FirstName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[2].CommandText = "SELECT        Id, FirstName, LastName, Email, Adress, Phone, Date\r\nFROM          " +
                "  Person\r\nWHERE        (Id = @pId)";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@pId", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "UPDATE       Person\r\nSET                FirstName = @FirstName, LastName = @LastN" +
                "ame, Email = @Email, Adress = @Adress, Phone = @Phone, Date = @Date\r\nWHERE      " +
                "  (Id = @Original_Id); ";
            ...
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Adress", global::System.Data.SqlDbType.NVarChar, 100, global::System.Data.ParameterDirection.Input, 0, 0, "Adress", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        public virtual int Fill(dsClasses.PersonDataTable dataTable, string par) {
        ...
        public virtual dsClasses.PersonDataTable GetData(string par) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((par == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            ...
            dsClasses.PersonDataTable dataTable = new dsClasses.PersonDataTable();
        ...
        public virtual int FillById(dsClasses.PersonDataTable dataTable, int pId) {
        ...
        public virtual dsClasses.PersonDataTable GetDataById(int pId) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(pId));
            dsClasses.PersonDataTable dataTable = new dsClasses.PersonDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsClasses.PersonDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsClasses dataSet) {
        ...
        public virtual int Delete(int Original_Id, string Original_FirstName, string Original_LastName, string Original_Email, string Original_Adress, int Original_Phone, global::System.Nullable<global::System.DateTime> Original_Date) {
        ...
        public virtual int Insert(string FirstName, string LastName, string Email, string Adress, int Phone, global::System.Nullable<global::System.DateTime> Date) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, string Email, string Adress, int Phone, global::System.Nullable<global::System.DateTime> Date, int Original_Id, string Original_FirstName, string Original_LastName, string Original_Email, string Original_Adress, int Original_Phone, global::System.Nullable<global::System.DateTime> Original_Date, int Id) {
            if ((FirstName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Email, string Adress, int Phone, global::System.Nullable<global::System.DateTime> Date, int Original_Id, string Original_FirstName, string Original_LastName, string Original_Email, string Original_Adress, int Original_Phone, global::System.Nullable<global::System.DateTime> Original_Date) {
            return this.Update(FirstName, LastName, Email, Adress, Phone, Date, Original_Id, Original_FirstName, Original_LastName, Original_Email, Original_Adress, Original_Phone, Original_Date, Original_Id);
        }
        ...
        public virtual int UpdateQuery(string FirstName, string LastName, string Email, string Adress, int Phone, global::System.Nullable<global::System.DateTime> Date, int Original_Id) {
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateUpdatedRows(dsClasses dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._personTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateInsertedRows(dsClasses dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._personTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateDeletedRows(dsClasses dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._personTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        public virtual int UpdateAll(dsClasses dataSet) {
            if ((dataSet == null)) {
